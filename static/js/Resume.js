...
var prevActiveDiv = document.querySelector(
  links[0].children[1].attributes.href.value
);
...
if (widthWindow <= 500) {
  ...
  links.forEach((link) => {
    ...
    link.addEventListener("click", () => {
      ...
      console.log("hello");
      var currentActiveDiv = document.querySelector(
        link.children[1].attributes.href.value
      );
...
if (cross) {
  cross.addEventListener("click", () => {
    ...
    document
      ...
      .classList.remove("active-message");
